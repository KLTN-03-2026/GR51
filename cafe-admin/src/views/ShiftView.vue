  ...
  <div class="shift-page fade-in">
    <div class="toolbar">
      <div class="toolbar-actions">
        <select v-model="filterNV" class="filter-select" @change="load"><option value="">Tất cả NV</option><option v-for="ns in nhanSus" :key="ns.id" :value="ns.id">{{ ns.ho_ten }}</option></select>
        <select v-model="filterTT" class="filter-select" @change="load"><option value="">Trạng thái</option><option :value="1">Đang mở</option><option :value="0">Đã đóng</option></select>
